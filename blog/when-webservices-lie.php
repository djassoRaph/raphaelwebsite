...
<head>
  ...
  <link rel="canonical" href="https://raphaelreck.com/blog/when-webservices-lie.php"/>
  ...
  <div class="container">
    ...
    <h2>The Setup</h2>
        ...
        <ul>
          ...
          <li>"Can you just make it work like the old system?"</li> <code> <span class="red"><i>Well I'm supposed to be here to improve this mess... </i></span></code>
        ...
        (if eligibilitechoix should happen here) (if email trigger with <span class="red">eligibiliteChoix</span>)
        ↓
